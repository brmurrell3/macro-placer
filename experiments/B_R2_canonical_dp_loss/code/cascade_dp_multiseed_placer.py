...
class CDLNSSACascadeDPMultiseedPlacer:
    """Cascade with B-R2-patched native DP as a third basin lane.

    Reads BR2_LAMBDA_TOPK and BR2_LAMBDA_RUDY from env to control the
    canonical-loss weights inside DREAMPlace's obj_fn (top-K density,
    RUDY congestion). When both are 0, behavior equals stock DP path.
    """

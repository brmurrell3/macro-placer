"""DPO ablation: congestion weight 1.00 (2x baseline, compensates RUDY underestimate)."""
...
class DPOCW100Placer(AblationDPOPlacer):
    def __init__(self):
        super().__init__(congestion_weight=1.00)

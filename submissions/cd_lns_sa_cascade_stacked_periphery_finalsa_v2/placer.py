...
_STACKED_PATH = _ROOT / "submissions" / "cd_lns_sa_cascade_stacked_finalsa_v2" / "placer.py"
_spec = importlib.util.spec_from_file_location("stacked_placer_finalsa_v2", str(_STACKED_PATH))
_stacked = importlib.util.module_from_spec(_spec)
_spec.loader.exec_module(_stacked)
CDLNSSACascadeStackedFinalSAV2Placer = _stacked.CDLNSSACascadeStackedFinalSAV2Placer
...
class CDLNSSACascadeStackedPeripheryFinalSAV2Placer:
    ...
    def place(self, benchmark: Benchmark) -> torch.Tensor:
        ...
        log(f"=== CDLNSSACascadeStackedPeripheryFinalSAV2Placer ({benchmark.name}) ===")
        t0 = time.time()
        ...
        stacked = CDLNSSACascadeStackedFinalSAV2Placer(

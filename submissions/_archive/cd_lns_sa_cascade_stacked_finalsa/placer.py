"""CDLNSSACascadeStackedFinalSAPlacer — cascade_saddle FOLLOWED BY portfolio_saddle.
...
class CDLNSSACascadeStackedFinalSAPlacer:
    ...
    def place(self, benchmark: Benchmark) -> torch.Tensor:
        ...
        log(f"=== CDLNSSACascadeStackedFinalSAPlacer ({benchmark.name}) ===")
        t0 = time.time()

"""V3Min ovl10 12-min with DPO init (instead of SDF)."""
...
class E111MinimalOvl10Dpo720sPlacer(_mod.E111MinimalPlacer):
    def __init__(self, **kwargs):
        kwargs.setdefault("budget_seconds", 720.0)
        kwargs.setdefault("cd_polish_s", 540.0)
        kwargs.setdefault("overlap_lambda_end", 10.0)
        kwargs.setdefault("init", "dpo")

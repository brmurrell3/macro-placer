...
| E43 | Longer K-joint budget (1200 s vs E41's 600 s) — tests if K=3 K-joint is budget-bound on larger benches | `experiments/E43_kjoint_longer/code/cd_lns_sa_dpo_kjoint_longer.py`, manifest | 0.91867 (--fast); -0.33 % vs E41 fast 0.92178 | fast | **MARGINAL 2026-04-30 14:23** — `--fast` lift at the gen-check threshold (0.3 %). Concentrated entirely on ibm13 (3450 macros, 72 commits in pass 1; smaller benches saturated K-joint within 600 s and converged in pass 2). Skipped --ng45 (3 hr wall doesn't fit budget; would only verify the budget-bound-on-large hypothesis). **K-joint is saturation-bound on small benches, marginally budget-bound on large ones.** |
